...
<div class="dodaj-izvestaj-middle">
    <div class="dodaj-izvestaj-title">GENERIŠI IZVEŠTAJ</div>
    <form method="POST" action="{{ route('izvestaj.store') }}" class="dodaj-izvestaj-form-wrap">
        @csrf

        <div class="dodaj-izvestaj-row">
            <label class="dodaj-izvestaj-form-label" for="naziv">Naziv:</label>
            <input id="naziv" name="naziv" class="dodaj-izvestaj-input" type="text" value="{{ old('naziv') }}" />
        </div>

        <div class="dodaj-izvestaj-row">
            <label class="dodaj-izvestaj-form-label" for="sadrzaj">Sadržaj:</label>
            <textarea id="sadrzaj" name="sadrzaj" class="dodaj-izvestaj-textarea">{{ old('sadrzaj') }}</textarea>
        </div>

        <div class="dodaj-izvestaj-row">
            <label class="dodaj-izvestaj-form-label" for="datum">Datum kreiranja:</label>
            <input id="datum" name="datum" class="dodaj-izvestaj-input dodaj-izvestaj-date" type="date" placeholder="Datum" value="{{ old('datum') }}" />
        </div>

        <div class="dodaj-izvestaj-row">
            <label class="dodaj-izvestaj-form-label" for="pdf_putanja">PDF putanja:</label>
            <input id="pdf_putanja" name="pdf_putanja" class="dodaj-izvestaj-input" type="text" value="{{ old('pdf_putanja') }}" />
        </div>
        ...
        <div class="dodaj-izvestaj-dugmici">
            <button class="dodaj-btn" type="submit">Generiši izveštaj</button>
