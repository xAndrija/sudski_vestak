...
<div class="dodaj-zahtev-middle">
    <div class="dodaj-zahtev-title">DODAJ ZAHTEV</div>
    <form method="POST" action="{{ route('zahtev.store') }}" class="dodaj-zahtev-form-wrap">
        @csrf

        <div class="dodaj-zahtev-row">
            <label class="dodaj-zahtev-form-label" for="broj_zahteva">Broj zahteva:</label>
            <input id="broj_zahteva" name="broj_zahteva" class="dodaj-zahtev-input" type="text" value="{{ old('broj_zahteva') }}" />
        </div>

        <div class="dodaj-zahtev-row">
            <label class="dodaj-zahtev-form-label" for="opis">Opis:</label>
            <input id="opis" name="opis" class="dodaj-zahtev-input" type="text" value="{{ old('opis') }}" />
        </div>
        ...
        <div class="dodaj-zahtev-row">
            ...
            <select id="tip_vestacenja" name="tip_vestacenja" class="dodaj-zahtev-select">
                ...
                <option value="poljoprivredno">Poljoprivredno</option>
                <option value="procena_stete">Procena štete</option>
            </select>
        </div>

        <div class="dodaj-zahtev-row">
            <label class="dodaj-zahtev-form-label" for="lokacija">Lokacija:</label>
            <input id="lokacija" name="lokacija" class="dodaj-zahtev-input" type="text" value="{{ old('lokacija') }}" />
        </div>

        <div class="dodaj-zahtev-row">
            <label class="dodaj-zahtev-form-label" for="datum_podnosenja">Datum podnošenja:</label>
            <input id="datum_podnosenja" name="datum_podnosenja" class="dodaj-zahtev-input dodaj-zahtev-date" type="date" placeholder="Datum" value="{{ old('datum_podnosenja') }}" />
        </div>
        ...
        <div class="dodaj-zahtev-row">
            ...
            <select id="klijent_id" name="klijent_id" class="dodaj-zahtev-select">
                ...
                @foreach(($klijents ?? []) as $klijent)
                    <option value="{{ $klijent->id }}" @if((string)old('klijent_id') === (string)$klijent->id) selected @endif>
        ...
        <div class="dodaj-zahtev-dugmici">
            <button class="dodaj-btn" type="submit">Dodaj zahtev</button>
